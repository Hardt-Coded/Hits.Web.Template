...
module Msal = 
    ...
    let msalAuthenticationTemplate : obj = import "MsalAuthenticationTemplate"   "@azure/msal-react"
    ...
    type IPublicClientApplication = 
        ...
        abstract member handleRedirectPromise: ?hash:string -> Promise<AuthenticationResult option>
    ...
    type PublicClientApplication (config:MsalConfig) =
        interface IPublicClientApplication with
            ...
            member _.handleRedirectPromise(?hash: string): Promise<AuthenticationResult option> = jsNative;
    ...
    type MsalProvider =
      static member inline instance (pca: obj) = prop.custom ("instance",pca)
      static member inline children (children: ReactElement list) : IReactProperty = prop.custom ("children", children)
      static member inline create  (props:IReactProperty seq) = Interop.reactApi.createElement (msalProvider, createObj !!props)
      static member inline create (children: ReactElement list) = Interop.reactApi.createElement (authenticatedTemplate, null, children)
    ...
    type AuthenticatedTemplate =
      static member inline children (children: ReactElement list) = prop.custom ("children", children)
    ...
    type UnauthenticatedTemplate  =
      ...
      static member inline create (children: ReactElement list) = Interop.reactApi.createElement (unauthenticatedTemplate, null, children)


    type MsalAuthenticationTemplate =
      static member inline children (children: ReactElement list) = prop.custom ("children", children)
      static member inline interactionType (t:InteractionType) = prop.custom ("interactionType", t)
      static member inline create props = Interop.reactApi.createElement (msalAuthenticationTemplate, createObj !!props)
      static member inline create (children: ReactElement list) = Interop.reactApi.createElement (msalAuthenticationTemplate, null, children)
