...
var CONFIG = {
    ...
    indexHtmlTemplate: './src/HitsWebAppTemplate.Client/index.html',
    fsharpEntry: './.fable-build/App.js',
    cssEntry: './src/HitsWebAppTemplate.Client/styles/styles.css',
    outputDir: './publish/app-fe',
    assetsDir: './src/HitsWebAppTemplate.Client/public',
    devServerPort: 8080,
